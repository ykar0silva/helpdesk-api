...
public class ChamadoController {
    ...
    @PostMapping
    public ResponseEntity<Chamado> create(
            @RequestParam("chamado") String chamadoJson,
    ...
    public ResponseEntity<Chamado> fecharChamado(
            @PathVariable Long id, 
            @RequestBody FechamentoChamadoDTO dto) {
